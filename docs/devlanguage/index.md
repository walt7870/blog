...
当前目录包含 Java、Rust、Flutter 和前端开发几条主线。阅读时可以先从本页判断语言定位，再进入对应专题。
...
| [Flutter](./flutter/) | Dart、Widget 模型、布局、状态、插件、性能、发布 | 移动应用、跨端应用、高一致性 UI、工程化客户端 |
...
- 能说明某个项目为什么选择 Java、Rust、Flutter 或前端技术栈，而不是只说“流行”。
